<?php require_once '../app/views/layout/header.php'; ?>
        ...
        <div class="max-w-4xl mx-auto bg-white p-10 sm:p-14 rounded-[2rem] shadow-xl shadow-slate-200/40 border border-slate-100">
            ...
            <form action="<?= BASE_URL ?>/index.php?url=book/update/<?= htmlspecialchars($book['id']) ?>" method="post" enctype="multipart/form-data" class="space-y-8">
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-600 mb-2">Obrázky (Zatím neřešíme zobrazení stávajících)</label>
                    <label class="w-full flex flex-col items-center px-4 py-8 bg-slate-50/50 text-slate-500 rounded-xl ring-1 ring-inset ring-slate-200 cursor-pointer hover:bg-slate-100 hover:ring-teal-300 transition-all">
                        <span class="font-medium text-slate-600">Klikni pro výběr nových souborů</span>
