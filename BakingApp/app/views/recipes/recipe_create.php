...
<div class="max-w-4xl mx-auto bg-white p-10 sm:p-14 rounded-[2rem] shadow-xl shadow-bake-brown/10 border border-bake-cream">
    ...
    <div class="mb-10 text-center">
        <h2 class="text-3xl font-semibold text-bake-brown mb-2">Přidat nový recept</h2>
    ...
    <form action="<?= BASE_URL ?>/index.php?url=recipe/store" method="post" enctype="multipart/form-data" class="space-y-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div class="sm:col-span-2">
                ...
                <input type="text" id="title" name="title" required class="w-full bg-bake-cream/30 border-0 text-slate-900 rounded-xl px-4 py-3.5 ring-1 ring-inset ring-bake-cream focus:ring-2 focus:ring-bake-blue transition-all">
            </div>
            ...
            <div>
                ...
                <input type="number" id="prep_time" name="prep_time" required min="1" class="w-full bg-bake-cream/30 border-0 rounded-xl px-4 py-3.5 ring-1 ring-inset ring-bake-cream focus:ring-2 focus:ring-bake-blue transition-all">
            </div>
        </div>

        <div>
            <label for="description" class="block text-sm font-semibold text-bake-brown mb-2">Krátký popis / Úvod</label>
            <textarea name="description" id="description" rows="3" class="w-full bg-bake-cream/30 border-0 rounded-xl px-4 py-3.5 ring-1 ring-inset ring-bake-cream focus:ring-2 focus:ring-bake-blue transition-all resize-y"></textarea>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
                ...
                <textarea name="ingredients" id="ingredients" rows="8" required placeholder="Např.:&#10;200 g hladké mouky&#10;2 vejce&#10;100 ml mléka" class="w-full bg-bake-cream/30 border-0 rounded-xl px-4 py-3.5 ring-1 ring-inset ring-bake-cream focus:ring-2 focus:ring-bake-blue transition-all resize-y"></textarea>
            </div>
            ...
            <div>
                ...
                <textarea name="instructions" id="instructions" rows="8" required placeholder="1. Smícháme suché suroviny...&#10;2. Přidáme vejce...&#10;3. Pečeme na 180°C." class="w-full bg-bake-cream/30 border-0 rounded-xl px-4 py-3.5 ring-1 ring-inset ring-bake-cream focus:ring-2 focus:ring-bake-blue transition-all resize-y"></textarea>
            </div>
        </div>

        <div>
            <label class="block text-sm font-semibold text-bake-brown mb-2">Obrázky k receptu</label>
            <div class="w-full">
        ...
        <div class="pt-8 mt-8 border-t border-bake-cream/50 flex items-center justify-between gap-4">
            <a href="<?= BASE_URL ?>/index.php" class="text-slate-400 hover:text-bake-brown font-medium px-2 py-2 transition-colors">Zrušit</a>
