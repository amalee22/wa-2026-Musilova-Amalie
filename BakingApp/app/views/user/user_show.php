...
<div class="max-w-5xl mx-auto space-y-10">
    ...
    <div class="bg-white p-10 rounded-[2rem] shadow-xl shadow-bake-brown/5 border border-bake-cream flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
        ...
        <div>
            ...
            <?php if(!empty($user['bio'])): ?>
                <p class="text-slate-600 font-serif italic max-w-2xl bg-bake-cream/30 p-4 rounded-xl border-l-4 border-bake-blue">"<?= nl2br(htmlspecialchars($user['bio'])) ?>"</p>
            <?php endif; ?>
        </div>
    </div>
